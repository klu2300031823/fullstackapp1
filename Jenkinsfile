pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://18.209.32.181:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    stages {
        stage('Clone Repository') {
            steps {
                git url: 'https://github.com/klu2300031823/fullstackapp1.git', branch: 'main'
            }
        }
    ...
    post {
        success {
            echo "✅ Backend deployed: http://18.209.32.181:9090/springapp1"
            echo "✅ Frontend deployed: http://18.209.32.181:9090/frontapp1"
        }
        failure {
